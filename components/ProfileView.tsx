...
const ProfileView: React.FC = () => {
  ...
  const handleSave = () => {
    dispatch({ type: 'UPDATE_CURRENT_USER', payload: { name: formData.name, avatar: formData.avatar } });
    dispatch({ type: 'ADD_TOAST', payload: { message: t('profile.saved.success'), type: 'success' } });
  };
