...
const UserSwitchModal: React.FC<UserSwitchModalProps> = ({ onClose }) => {
  ...
  const handleSwitchUser = (userId: string) => {
    // This functionality is deprecated as the current user is tied to Firebase Auth.
    // To switch user, one must log out and log in again.
    console.warn("User switching is not supported in this version.");
    onClose();
  };
