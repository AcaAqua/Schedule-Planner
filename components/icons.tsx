...
export const LanguageIcon = (props: { className?: string }) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export const SwordsIcon = ({ className }: { className?: string }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
        <path d="M14.631 3.144l5.855 5.855-2.242 2.242-5.855-5.855zM3.144 14.631l5.855 5.855 2.242-2.242-5.855-5.855z" />
        <path d="M12.44 3.32L3.32 12.44l8.06 8.06 9.12-9.12-8.06-8.06zM11 13l-2 2-7-7 2-2 7 7z" />
    </svg>
);

export const UpdateIcon = ({ className }: { className?: string }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0 0 11.667 0l3.181-3.183m-4.991-2.691v4.992h-4.992m0 0l-3.181-3.183a8.25 8.25 0 0 1 11.667 0l3.181 3.183" />
    </svg>
);

export const MaintIcon = ({ className }: { className?: string }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.17L17.25 21A2.652 2.652 0 0021 17.25l-5.83-5.83M11.42 15.17l2.496-3.03c.317-.384.73-.664 1.193-.816l1.658-2.28a2.25 2.25 0 00-3.182-3.182l-2.28 1.658a1.125 1.125 0 00-.816 1.193l-3.03 2.496m11.42 6.82l-6.82-11.42" />
    </svg>
);
...
export const UsersIcon = (props: { className?: string }) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.742-.586l-.001-.001a3.375 3.375 0 0 0-3.486-3.485l-.001-.001A9.094 9.094 0 0 0 18 18.72ZM6 18.72a9.094 9.094 0 0 1-3.742-.586l.001-.001a3.375 3.375 0 0 1 3.486-3.485l.001-.001A9.094 9.094 0 0 1 6 18.72Zm12 0a9.094 9.094 0 0 0-3.742.586m0 0a3.375 3.375 0 0 0-3.486 3.486l0 0a3.375 3.375 0 0 0 3.486 3.486l0 0a3.375 3.375 0 0 0 3.486-3.486l0 0a3.375 3.375 0 0 0-3.486-3.486M9 4.5a3.375 3.375 0 0 1 3.375 3.375v1.5a3.375 3.375 0 0 1-3.375 3.375h-1.5A3.375 3.375 0 0 1 4.125 9.375v-1.5A3.375 3.375 0 0 1 7.5 4.5h1.5Zm9 0a3.375 3.375 0 0 1 3.375 3.375v1.5a3.375 3.375 0 0 1-3.375 3.375h-1.5a3.375 3.375 0 0 1-3.375-3.375v-1.5A3.375 3.375 0 0 1 16.5 4.5h1.5Z" />
    </svg>
);
...
export const ArrowPathRoundedSquareIcon = (props: { className?: string }) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0 0 11.667 0l3.181-3.183m-4.991-2.691V7.5a3 3 0 0 1 3-3h.008a3 3 0 0 1 3 3v.207" />
    </svg>
);
...
export const ShareIcon = (props: { className?: string }) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export const getIconComponentByName = (name: string): React.ComponentType<{ className?: string }> => {
    return ICON_MAP[name] || TagIcon;
};